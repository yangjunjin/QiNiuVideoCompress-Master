...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_start).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO 修改这里的原始视频路径
                String videoPath = LOCAL_PATH + "/test.mp4";
                tv_startSize.setText("压缩前视频大小:" + new File(videoPath).length()/1024f/1024f+"MB");
    ...
    private void startCompressed(String videoPath) {
        ...
        File file = new File(LOCAL_PATH + "compress.mp4");
        file.mkdir();

        PLShortVideoTranscoder mShortVideoTranscoder = new PLShortVideoTranscoder(this, videoPath, LOCAL_PATH + "/compress.mp4");
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 103:
                    ...
                    tv_endSize.setText("压缩后视频大小:" +  new File(newPath).length()/1024f/1024f+"MB");
                    int time = (int) ((System.currentTimeMillis() - startTime) / 1000);
                    tv_time.setText("压缩用时：" + time + "秒");
                    textView.setText("压缩完成");
                    Log.e("MainActivity===path2==",compressedFilePath);
                    break;
            }
            return false;
        }
